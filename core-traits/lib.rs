...
impl Display for TypedValue {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            &TypedValue::Ref(ref v) => write!(f, "{}", v),
            &TypedValue::Boolean(ref v) => write!(f, "{}", v),
            &TypedValue::Long(ref v) => write!(f, "{}", v),
            &TypedValue::Double(ref v) => write!(f, "{}", v),
            &TypedValue::Instant(ref v) => write!(f, "{}", v),
            &TypedValue::String(ref v) => write!(f, "{}", v),
            &TypedValue::Keyword(ref v) => write!(f, "{}", v),
            &TypedValue::Uuid(ref v) => write!(f, "{}", v.hyphenated()),
        }
    }
}
